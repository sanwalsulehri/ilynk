  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4  py-16 lg:py-16">
        ...
        <motion.div
          className="mt-6 flex flex-col lg:flex-row justify-between  gap-6 lg:gap-10"
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          >
            <video
              ...
              loop
              playsInline
              className="lg:h-auto h-[450px]  w-full  rounded-lg"
            />
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <div className="flex flex-col gap-8">
          <h1 className="font-bold leading-tight uppercase text-black text-[36px] lg:text-[58px]">
            our flagship{" "}
          ...
          >
            ...
            >
              <img
                ...
                className="block h-full lg:h-[450px] w-full mx-auto lg:mx-0 max-w-[355px] object-cover"
              />
            </motion.div>
          ...
          >
            ...
            >
              <img
                ...
                className="block h-full lg:h-[450px] mx-auto lg:mx-0 w-full max-w-[355px] object-cover"
              />
            </motion.div>
          </motion.div>
        </div>
