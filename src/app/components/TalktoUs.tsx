...
const TalktoUs = () => {
  return (
    ...
    >
      <motion.div
        className="mx-auto grid max-w-[1200px] grid-cols-1 lg:grid-cols-2"
        variants={stagger}
      >
        ...
        {/* Right: content */}
        <motion.div
          className="relative flex flex-col gap-6 px-5 py-8 lg:px-8 lg:py-16"
          variants={stagger}
        >
          <motion.h2
            id="talk-to-us-heading"
            className="text-[28px] font-extrabold tracking-[2px] text-black lg:text-[44px] xl:text-[56px] [text-shadow:0_3px_0_rgba(0,0,0,0.15)]"
            variants={fadeUp}
          >
            TALK TO US
          </motion.h2>
          ...
          <dl className="grid gap-3">
            <motion.div
              className="grid lg:text-[18px] grid-cols-[120px_1fr] items-start gap-3"
              variants={fadeUp}
            >
              <dt className="font-bold tracking-[0.5px] text-neutral-900">
                ADDRESS:
              </dt>
          ...
          <motion.div className="mt-2 flex gap-8" variants={fadeUp}>
            ...
            <a className="" href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-10 h-10 text-[#0866FF] "
                width="24"
                height="24"
                viewBox="0 0 24 24"
              >
            ...
            <a className="" href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-10 text-[#E9333D] h-10 "
                width="24"
                height="24"
                viewBox="0 0 24 24"
              >
